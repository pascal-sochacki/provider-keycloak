...
The [provider-keycloak](https://github.com/pascal-sochacki/provider-keycloak) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-keycloak](https://github.com/crossplane-contrib/provider-jet-keycloak) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/pascal-sochacki/provider-keycloak/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/pascal-sochacki/provider-keycloak/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/pascal-sochacki/provider-keycloak/blob/main/hack/boilerplate.go.txt](https://github.com/pascal-sochacki/provider-keycloak/blob/main/hack/boilerplate.go.txt)
...
The [provider-keycloak](https://github.com/pascal-sochacki/provider-keycloak)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/pascal-sochacki/provider-keycloak/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/pascal-sochacki/provider-keycloak/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue keycloaks (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/pascal-sochacki/provider-keycloak/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Keycloaks: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/pascal-sochacki/provider-keycloak/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
